...
import 'consult_product_dish_model.dart';
export 'consult_product_dish_model.dart';

class ConsultProductDishWidget extends StatefulWidget {
  const ConsultProductDishWidget({Key? key}) : super(key: key);

  @override
  _ConsultProductDishWidgetState createState() =>
      _ConsultProductDishWidgetState();
}

class _ConsultProductDishWidgetState extends State<ConsultProductDishWidget> {
  ...
  void initState() {
    super.initState();
    _model = createModel(context, () => ConsultProductDishModel());
                  ...
                  Padding(
                    ...
                    child: Row(
                      ...
                      children: [
                        FFButtonWidget(
                          onPressed: () async {
                            _model.apiResultloh = await ConsultProductCall.call(
                              consultBarcode: _model.textController.text,
                            );
                            if ((_model.apiResultloh?.succeeded ?? true)) {
                              ...
                              ScaffoldMessenger.of(context).showSnackBar(
                                SnackBar(
                                  content: Text(
                                    'The Barcode isn\'t correct or the product don\'t exists',
                                    style: TextStyle(
                                      color: FlutterFlowTheme.of(context)
                                          .primaryText,
                                    ),
